...
public class Statuses : MonoBehaviour {
	...
	void Start () {
        ...
        enemyIcons = new GameObject[][] {
            new GameObject[] {
            Object.Instantiate(burnIcon, positions[0] + new Vector3(-1, 2), Quaternion.identity),
            Object.Instantiate(attackBoostIcon, positions[0] + new Vector3(0, 2), Quaternion.identity),
            Object.Instantiate(attackDebuffIcon, positions[0] + new Vector3(1, 2), Quaternion.identity)},
            new GameObject[] {
            Object.Instantiate(burnIcon, positions[1] + new Vector3(-1, 2), Quaternion.identity),
            Object.Instantiate(attackBoostIcon, positions[1] + new Vector3(0, 2), Quaternion.identity),
            Object.Instantiate(attackDebuffIcon, positions[1] + new Vector3(1, 2), Quaternion.identity)},
            new GameObject[] {
            Object.Instantiate(burnIcon, positions[2] + new Vector3(-1, 2), Quaternion.identity),
            Object.Instantiate(attackBoostIcon, positions[2] + new Vector3(0, 2), Quaternion.identity),
            Object.Instantiate(attackDebuffIcon, positions[2] + new Vector3(1, 2), Quaternion.identity)}
        };
    }
	...
	void Update () {
        ...
        for (int j = 0; j < 3; j++)
        {
            ...
            {
                bool[] render2 = getStatuses(enemies[j]);
